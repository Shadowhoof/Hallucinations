...
#include "Core/HWaveGameMode.h"
#include "Kismet/GameplayStatics.h"
#include "Actors/HSpawnPoint.h"
...
void AHWaveGameMode::SpawnEnemies()
{
	...
	UGameplayStatics::GetAllActorsOfClass(GetWorld(), AHSpawnPoint::StaticClass(), SpawnPoints);
	...
	for (int i = 0; i < EnemiesPerWave; i++)
	{
		...
		AHSpawnPoint* SpawnPoint = Cast<AHSpawnPoint>(SpawnPoints[RandomSpawnPointIndex]);
